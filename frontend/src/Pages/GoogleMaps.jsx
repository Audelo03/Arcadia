    ...
    if (!wsRef.current) {
        ...
        wsRef.current.onmessage = (event) => {
            try {
                ...
                console.error('Error processing WebSocket message in GoogleMaps:', e);
